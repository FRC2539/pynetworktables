...
namespace wpiclass NetworkStream


namespace nt
class Notifier

class NetworkConnection public:
  ...
  void set_process_incoming(ProcessIncomingFunc func)    m_process_incoming = func
 ...
 private:
  ...
  std.vector<std.pair<std.size_t, m_pending_update
